...
pub fn router_with_frontend(state: AppState, frontend_dir: Option<&str>) -> Router {
    let mut app = Router::new()
        ...
        .route("/chat/dossier", post(handlers::chat_analysis::dossier))
        .route("/chat/topic_map", post(handlers::chat_analysis::topic_map))
        .route("/chat/graph_stats", post(handlers::chat_analysis::graph_stats))
